...
database_interpreter(excel_source="SomeExcelWithNewUsers.xlsx", sheet_name="Лист1", columns=["A", "B", "C"],
                     source_for_user="workWithExcelFile/excelDatabase/10class/10class.xlsx",
