            ...
            # main_keyboard - working with commands of this level
                ...
                if presence_user != []:
                    write_msg(user_id=event.object.peer_id,
                              ...
                              message="Это раздел настроек - если плитка зелёная, то функция включена, если же красная, то выключена. Чтобы изменить один из параметров, следует нажать на него🤗")
